...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Blog Default" wrapperCls="home_1">
                <div>
                        ...
                        <div className="auto-container">
                            <div className="row">
                                <div className="col-lg-8 content-side order-lg-2">
                                    <div className="row">
                                        <div className="col-md-6 news-block-two">
                                        ...
                                        <div className="col-md-6 news-block-two">
                                            <div className="inner-box">
                                                <div className="image">
                                                    <Link href="/blog-details"><img className="lazy-image owl-lazy" src="/assets/images/resource/news-20.jpg" alt="" /></Link>
                                                </div>
                                                <div className="lower-content">
                                                    <div className="category">Business</div>
                                                    <ul className="post-meta">
