...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Blog Gird View" wrapperCls="home_1">
                <div>
                                ...
                                <div className="col-lg-8 content-side">
                                    <div className="news-block-six">
                                        <div className="inner-box">
                                            <div className="image">
                                                <Link href="/blog-details"><img className="lazy-image owl-lazy" src="/assets/images/resource/news-27.jpg" alt="" /></Link>
                                            </div>
                                            <div className="lower-content">
                                                ...
                                                <div className="text">Nor again is there anyone who loves or pursues or desires to obtain pain of itself, because it is pain, but because occasionally circumstances occur in which toil and pain can procure him some great pleasure...</div>
                                    ...
                                    <div className="news-block-six">
                                        <div className="inner-box">
                                            <div className="image">
                                                <Link href="/blog-details"><img className="lazy-image owl-lazy" src="/assets/images/resource/news-28.jpg" alt="" /></Link>
                                            </div>
                                            <div className="lower-content">
                                                <div className="category">Business</div>
                                                <ul className="post-meta">
                                                    ...
                                                    <li>/</li>
                                                    <li><i className="far fa-comment-alt" />3 Comments</li>
                                                </ul>
                                                <h4><Link href="/blog-details">Is Your Business Ready For <br />Integration?</Link></h4>
                                                <div className="text">To take a trivial example, which of us ever undertakes laborious physical exercise, except to obtain some advantage from it? But who has any right to find fault with to enjoy a consequences,..</div>
                                                <div className="bottom-content">
                                                    <Link href="/blog-details" className="theme-btn btn-style-one"><span className="btn-title">READ MORE</span></Link>
                                                    <div className="post-share-btn">
                                                        <div className="social-links-wrapper">
                                    ...
                                    <div className="news-block-six">
                                        <div className="inner-box">
                                            <div className="image">
                                                <Link href="/blog-details"><img className="lazy-image owl-lazy" src="/assets/images/resource/news-29.jpg" alt="" /></Link>
                                            </div>
                                            <div className="lower-content">
                                                <div className="category">Business</div>
                                                <ul className="post-meta">
                                                ...
                                                <div className="text">Ever undertakes laborious physical exercise, except to obtain some advantage for it but who has any right to find fault with a man who chooses to enjoy a pleasure that has no one who avoids a pain that produces... </div>
                                                <div className="bottom-content">
                                                    <Link href="/blog-details" className="theme-btn btn-style-one"><span className="btn-title">READ MORE</span></Link>
                                                    <div className="post-share-btn">
                                                        <div className="social-links-wrapper">
                                    ...
                                    <div className="news-block-six">
                                        <div className="inner-box">
                                            <div className="image">
                                                <Link href="/blog-details"><img className="lazy-image owl-lazy" src="/assets/images/resource/news-30.jpg" alt="" /></Link>
                                            </div>
                                            <div className="lower-content">
                                                <div className="category">Business</div>
                                                <ul className="post-meta">
                                    ...
                                    <div className="news-block-six">
                                        <div className="inner-box">
                                            <div className="image">
                                                <Link href="/blog-details"><img className="lazy-image owl-lazy" src="/assets/images/resource/news-31.jpg" alt="" /></Link>
                                            </div>
                                            <div className="lower-content">
                                                <div className="category">Business</div>
                                                <ul className="post-meta">
