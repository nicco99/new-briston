        ...
        >
          <SwiperSlide className="slide-item">
            <div
              ...
              data-bg="/assets/images/main-slider/1.jpg"
            />
            <div className="auto-container">
              <div className="content-box justify-content-end">
                <div>
                  <h3>Briston Will Helping </h3>
                  <h2>
                    Build and <br /> Grow Business
                  </h2>
                  <div className="text">
                    We offer the Best Human Resource Solutions For Your Business
                  </div>
                  <div className="btn-box">
                    <Link href="#" className="theme-btn btn-style-one">
                      <span className="btn-title">Our Company</span>
                    </Link>
          ...
          <SwiperSlide className="slide-item">
            <div
              className="image-layer lazy-image"
              data-bg="/assets/images/main-slider/2.jpg"
            />
            <div className="auto-container">
              <div className="content-box justify-content-end">
                <div>
                  ...
                  <div className="text">
                    We are biased more toward payroll and recruitment as our
                    core functions.
                  </div>
                  <div className="btn-box">
                    <Link href="#" className="theme-btn btn-style-one">
