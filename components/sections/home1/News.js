      ...
      <section className="news-section">
        <div className="wrapper-box">
          <div
            ...
            style={{ backgroundImage: "url(assets/images/background/bg3.jpg)" }}
          >
            <div className="outer-box">
              ...
              <ul>
                <li>
                  ...
                  Consultants advice &amp; suggestions
                </li>
                <li>
                  <i className="fa fa-star" />
          ...
          <div className="right-column">
            <div className="outer-box">
              ...
              <div className="news-carousel-wrapper">
                <Swiper
                  {...swiperOptions}
                  className="swiper-container news-carousel"
                >
                  <SwiperSlide>
                    {/* News Block */}
                      ...
                      <div className="inner-box">
                        <div className="row m-0 justify-content-between">
                          ...
                          <div className="author">
                            ...
                            <img
                              src="/assets/images/resource/author-thumb1.jpg"
                              alt=""
                            />
                          </div>
                        </div>
                  ...
                  <SwiperSlide>
                    ...
                    <div className="news-block-one">
                      <div className="inner-box">
                        <div className="row m-0 justify-content-between">
                          <div className="date">
                            <strong>21</strong>August <br />
                            2023
                          </div>
                          <div className="author">
                            <div className="title">Raana irave </div>
                            <img
                              src="/assets/images/resource/author-thumb2.jpg"
                              alt=""
                            />
                          </div>
                        </div>
                  ...
                  <SwiperSlide>
                    ...
                    <div className="news-block-one">
                      <div className="inner-box">
                        <div className="row m-0 justify-content-between">
                          <div className="date">
                            <strong>08</strong>August <br />
                            2023
                          </div>
                          <div className="author">
                            <div className="title">Raana irave </div>
                            <img
                              src="/assets/images/resource/author-thumb3.jpg"
                              alt=""
                            />
                          </div>
                        </div>
